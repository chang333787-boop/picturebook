  ...
  var TEACHER = {
    ...
    sections: [
      ...
      { n: 5, h: '학생 작품 관리하기 (공개·수정·감상)', steps: [
        '팀 목록에서 모둠마다 🛠 수정·▶ 감상, ⋯ 메뉴의 🖨 인쇄를 쓸 수 있어요. 선생님은 PIN 없이 바로 편집돼요.',
        '작품을 “공개(발행)”하면 감상 화면(뷰어)에서 볼 수 있어요. ▶ 감상 버튼은 작품이 감상 가능 상태(🟢)일 때 켜지고, 공개 전에는 🛠 수정으로 들어가 내용을 볼 수 있어요.',
        '🛠 수정으로 들어가 글·그림을 직접 고치고, ▶ 감상으로 완성한 이야기를 처음부터 읽어볼 수 있어요.',
