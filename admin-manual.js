...
;(function () {
  ...
  var STUDENT_L1 = {
    ...
    intro: '생각 나침반에 답하면 AI가 이야기를 만들어 줘요. 글과 그림을 예쁘게 다듬어요. (1~6학년 누구나 · 처음 만들 때)',
    sections: [
      { n: 1, h: '들어가기', steps: [
  ...
  var STUDENT_L2 = {
    ...
    intro: 'AI가 처음 3장면을 시작해 주면, 내가 뒤를 이어서 완성해요. 그림은 내가 구도를 그리면 AI가 완성해요. (중·고학년 추천)',
    sections: [
      { n: 1, h: '들어가기', steps: [
        '클래스 코드, 모둠 이름, 비밀번호(PIN)를 차례로 넣어요.',
        'PIN은 선생님이 준 카드에 적혀 있어요.',
  ...
  var STUDENT_L3 = {
    ...
    intro: '내가 장면을 만들고, 선택에 따라 이야기가 여러 갈래로 갈라지게 만들어요. (중·고학년 추천 · 텍스트·무비도 이렇게 만들어요)',
    sections: [
      { n: 1, h: '들어가기', steps: [
        '클래스 코드, 모둠 이름, 비밀번호(PIN)를 차례로 넣어요.',
