...
- **실학급 스캔(2026-09-05)**: 1단계 팀은 연습반 11·연구대회 학급 7뿐 — **실수업 학급(40팀)·우리반 만세엔 1단계 팀 없음**. 그림 0장 고아 3팀(연습반 검토A·검토E, 연구대회 학급 1단계3)은 다음 입장 때 선택 카드→배치가 돈다(각 ~$0.6·의도된 동작). 나머지는 전부 완료(DONE=무소음)거나 초안 전(NONE).
