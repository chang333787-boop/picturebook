...
- 작품 평가성 칭찬: "이 작품은 훌륭해요", "정말 잘 쓴 작품이에요", "아주 재미있는 작품이에요"
  (AI가 작품 전체를 평가하지 않음)
- 새 사건/인물/배경 제안
...
[허용 — 진단 결과 안내형 긍정 표현]
- "지금은 확인할 문제가 많지 않아요"
- "이 부분은 그대로 두어도 괜찮아 보여요"
- "장면 사이 흐름이 자연스러워 보여요"
- "맞춤법은 큰 문제 없어 보여요"
→ 진단 결과를 친화적으로 안내하는 긍정 표현은 허용.
   작품 전체 가치를 평가하는 칭찬은 금지.
...
## 5-3. 약한 경고 (UI 표시)
1. **작품 평가성 칭찬** — AI는 작품 전체 가치를 평가 X
   - "이 작품은 훌륭해요"
   - "정말 잘 쓴 작품이에요"
   - "아주 재미있는 작품이에요"
2. **카테고리당 8개 이상** ("많이 박혔어요" 라벨)

**경고 대상 아님 (허용 — 진단 결과 안내형 긍정)**:
- "지금은 확인할 문제가 많지 않아요"
- "이 부분은 그대로 두어도 괜찮아 보여요"
- "장면 사이 흐름이 자연스러워 보여요"
...
작품 전체를 평가하는 칭찬과, 진단 결과를 친화적으로 안내하는 긍정 표현을 구분.
