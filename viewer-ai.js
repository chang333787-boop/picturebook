...
(function () {
  ...
  const IMAGE_AI_NOTICE = {
    ...
    /* IMAGE-S2-PEOPLE(2026-07-09): 사람(얼굴) 사진은 AI가 변환하기 어려워 거부됨.
       MODERATION-COPY(#61): 직접 그린 그림만 있는 팀도 만날 수 있어 병렬형(흔한 사유 + 대안)으로. */
    IMAGE_AI_UNSAFE_OUTPUT: 'AI가 이 그림을 안전 기준 때문에 변환하지 못했어요.\n사람 얼굴이 크게 나온 사진이 가장 흔한 사유예요.\n그림 내용을 바꾸거나 원본을 그대로 사용해 주세요.',
